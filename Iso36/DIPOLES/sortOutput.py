...
df_pve = pd.read_csv("CO36-Dipole-pve.dat", delim_whitespace=True, names=["r", "+ve"])
df_nve = pd.read_csv("CO36-Dipole-nve.dat", delim_whitespace=True, names=["r", "-ve"])
